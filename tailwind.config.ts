  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "pace-leg-a": "pace-leg-a 1.4s ease-in-out infinite",
        "pace-leg-b": "pace-leg-b 1.4s ease-in-out infinite",
        "pace-arm-a": "pace-arm-a 1.4s ease-in-out infinite",
        "pace-arm-b": "pace-arm-b 1.4s ease-in-out infinite",
        "pace-bob": "pace-bob 0.7s ease-in-out infinite",
